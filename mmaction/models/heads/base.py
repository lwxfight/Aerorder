...
class BaseHead(BaseModule, metaclass=ABCMeta):
    ...
    def loss(self, feats: Union[torch.Tensor, Tuple[torch.Tensor]],
        ...
        """
        cls_scores, features = self(feats, **kwargs)
    ...
    def predict(self, feats: Union[torch.Tensor, Tuple[torch.Tensor]],
        ...
        """
        # print('-----1-------')
        cls_scores, features = self(feats, **kwargs)  # 进入x3d_head.py
        # print('cls_scores:', cls_scores)
        # cls_scores = self(feats, **kwargs)  # 进入x3d_head.py
        # print('feature:', feature)
        # print('feature.shape:', feature.shape)  # feature.shape: torch.Size([8, 2048])
        # print('data_samples:', data_samples)
        gt_labels_list = [sample.gt_labels.item.item() for sample in data_samples]
        # print('gt_labels_list:', gt_labels_list)  # gt_labels_list: [10, 10, 2, 4, 5, 7, 8, 9]
        # feats是形状为[B, C, T, H, W]的五维特征
        # 将其转换为二维数组，形状为[B, C * T * H * W]
        # feats_reshaped = feats.reshape(feats.shape[0], -1)

        # 使用t-SNE降维到两维
        # tsne = TSNE(n_components=2, random_state=42)
        # feats_tsne = tsne.fit_transform(feats_reshaped, perplexity=5)

        # with open('/home/zhouzhuo/project/mmaction2/tsne/Drone/five/view3/feature.txt', 'a') as file:
        #     for feature in features:
        #         for value in feature.cpu().detach().numpy():
        #             file.write(str(value) + ' ')
        #         file.write('\n')
        #
        # # # 保存gt_labels_list到文本文件
        # with open('/home/zhouzhuo/project/mmaction2/tsne/Drone/five/view3/label.txt', 'a') as file:
        #     for label in gt_labels_list:
        #         file.write(str(label) + '\n')
        #
        # with open('/home/zhouzhuo/project/mmaction2/tsne/MOD/Same-11/view-all/feature.txt', 'a') as file:
        #     for feature in features:
        #         for value in feature.cpu().detach().numpy():
        #             file.write(str(value) + ' ')
        #         file.write('\n')
        #         #file.write(str(feature.cpu().detach().numpy()) + '\n')
        #
        # # 保存gt_labels_list到文本文件
        # with open('/home/zhouzhuo/project/mmaction2/tsne/Drone/Test1/view2/label.txt', 'a') as file:
        #     for label in gt_labels_list:
        #         file.write(str(label) + '\n')
        #
        # with open('/home/zhouzhuo/project/mmaction2/tsne/Drone/Test1/view3/feature.txt', 'a') as file:
        #     for feature in features:
        #         for value in feature.cpu().detach().numpy():
        #             file.write(str(value) + ' ')
        #         file.write('\n')
        #
        # # 保存gt_labels_list到文本文件
        # with open('/home/zhouzhuo/project/mmaction2/tsne/Drone/Test1/view3/label.txt', 'a') as file:
        #     for label in gt_labels_list:
        #         file.write(str(label) + '\n')

        # with open('/home/zhouzhuo/project/mmaction2/tsne/Drone/Test1/view4/feature.txt', 'a') as file:
        #     for feature in features:
        #         for value in feature.cpu().detach().numpy():
        #             file.write(str(value) + ' ')
        #         file.write('\n')
        #
        # # 保存gt_labels_list到文本文件
        # with open('/home/zhouzhuo/project/mmaction2/tsne/Drone/Test1/view4/label.txt', 'a') as file:
        #     for label in gt_labels_list:
        #         file.write(str(label) + '\n')

        # with open('/home/zhouzhuo/project/mmaction2/tsne/Drone/Train1/view5/feature.txt', 'a') as file:
        #     for feature in features:
        #         for value in feature.cpu().detach().numpy():
        #             file.write(str(value) + ' ')
        #         file.write('\n')
        #
        # # 保存gt_labels_list到文本文件
        # with open('/home/zhouzhuo/project/mmaction2/tsne/Drone/Train1/view5/label.txt', 'a') as file:
        #     for label in gt_labels_list:
        #         file.write(str(label) + '\n')
        #
        # with open('/home/zhouzhuo/project/mmaction2/tsne/Drone/Train1/view-all/feature.txt', 'a') as file:
        #     for feature in features:
        #         for value in feature.cpu().detach().numpy():
        #             file.write(str(value) + ' ')
        #         file.write('\n')
        #
        # # 保存gt_labels_list到文本文件
        # with open('/home/zhouzhuo/project/mmaction2/tsne/Drone/Train1/view-all/label.txt', 'a') as file:
        #     for label in gt_labels_list:
        #         file.write(str(label) + '\n')


        # print('data_samples:', gt_labels_list)  # data_samples: [1, 2, 2, 3, 3, 4, 4, 5]

        # print('cls_scores:', cls_scores)  # cls_scores: tensor([[-2.7375, -2.6658,  0.5707, -2.6387,  5.9402, -0.1592, -2.7680,  2.3715,
                                            #  -1.4758, -0.6918,  6.5620,  0.0540, -2.4891],
                                            # [-2.2052, -2.4750, -0.1500, -2.2461,  5.2325, -0.8468, -2.2928,  3.4319,
                                            #  -0.7790, -0.4424,  5.7856, -0.6773, -2.2425],
                                            # [-3.6781, -3.6715,  6.6050, -3.4097,  0.8408, -0.2037, -3.3634, -1.9047,
                                            #  -0.6267,  6.3884,  2.5647,  3.2570, -3.4315],
                                            # [-2.1614, -2.2829, -0.7269, -2.2231,  6.6363, -1.2276, -2.2299,  3.0346,
                                            #  -1.0360, -0.6029,  5.8278, -0.5071, -2.2779],
                                            # [-2.4719, -2.6773,  1.2460, -2.3971,  1.1318,  2.4606, -2.4225,  2.4322,
                                            #   2.8463,  1.1182,  1.2413,  0.4004, -2.6587],
                                            # [-1.8970, -1.8578, -0.7931, -1.8132,  5.6730, -1.2288, -1.8272,  3.0038,
                                            #  -0.3667, -0.9854,  4.8353, -0.5981, -1.9815],
                                            # [-2.2541, -2.3852,  1.0889, -2.2507,  0.3262,  2.8358, -2.1354,  1.4741,
                                            #   3.1908,  1.7671,  0.7980,  0.5476, -2.3998],
                                            # [-3.3092, -3.3835,  5.3011, -3.1912,  0.0142, -0.1362, -3.1604, -0.8433,
                                            #   0.0464,  7.1387,  0.9868,  3.6811, -3.1932]], device='cuda:0')
